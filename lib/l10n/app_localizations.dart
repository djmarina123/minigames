...
abstract class AppLocalizations {
  ...
  /// No description provided for @gameDominoTitle.
  ///
  /// In pt, this message translates to:
  /// **'Dominó'**
  String get gameDominoTitle;

  /// No description provided for @gameDominoDescription.
  ///
  /// In pt, this message translates to:
  /// **'Jogue peças contra a CPU e esvazie sua mão.'**
  String get gameDominoDescription;

  /// No description provided for @gameDominoHowToPlay.
  ///
  /// In pt, this message translates to:
  ...
  /// No description provided for @gameDominoScoring.
  ///
  /// In pt, this message translates to:
  ...
  /// No description provided for @gameDominoCpuDrew.
  ///
  /// In pt, this message translates to:
  /// **'CPU comprou'**
  String get gameDominoCpuDrew;

  /// No description provided for @gameDominoCpuPassed.
  ///
  /// In pt, this message translates to:
  /// **'CPU passou'**
  String get gameDominoCpuPassed;

  /// No description provided for @gameDominoDropOnEnd.
  ///
  /// In pt, this message translates to:
  /// **'Solte na ponta certa'**
  String get gameDominoDropOnEnd;

  /// No description provided for @gameDominoNoFit.
  ///
  /// In pt, this message translates to:
  /// **'Não encaixa'**
  String get gameDominoNoFit;

  /// No description provided for @gameDominoCpuPlayed.
  ///
  /// In pt, this message translates to:
  /// **'CPU: {tile}'**
  String gameDominoCpuPlayed(String tile);

  /// No description provided for @gameDominoNoPlayPass.
  ///
  /// In pt, this message translates to:
  /// **'Sem jogada — passe'**
  String get gameDominoNoPlayPass;

  /// No description provided for @gameDominoBoneyard.
  ///
  /// In pt, this message translates to:
  /// **'Monte'**
  String get gameDominoBoneyard;

  /// No description provided for @gameDominoDraw.
  ///
  /// In pt, this message translates to:
  /// **'Comprar'**
  String get gameDominoDraw;

  /// No description provided for @gameDominoPass.
  ///
  /// In pt, this message translates to:
  /// **'Passar'**
  String get gameDominoPass;

  /// No description provided for @gameDominoCpuOpening.
  ///
  /// In pt, this message translates to:
  /// **'CPU abrindo…'**
  String get gameDominoCpuOpening;

  /// No description provided for @gameDominoDragOpening.
  ///
  /// In pt, this message translates to:
  /// **'Arraste a peça de abertura'**
  String get gameDominoDragOpening;

  /// No description provided for @gameDominoDragToTable.
  ///
  /// In pt, this message translates to:
  /// **'Arraste uma peça para a mesa'**
  String get gameDominoDragToTable;

  /// No description provided for @gameDominoYourTurn.
  ///
  /// In pt, this message translates to:
  /// **'Sua vez'**
  String get gameDominoYourTurn;

  /// No description provided for @gameDominoCpuTurn.
  ///
  /// In pt, this message translates to:
  /// **'CPU'**
  String get gameDominoCpuTurn;
