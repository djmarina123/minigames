...
class CrossSumsFloatingLabel extends PositionComponent {
  CrossSumsFloatingLabel({
...
class CrossSumsCellBurst extends PositionComponent {
  CrossSumsCellBurst({
    required super.position,
    this.color = CrossSumsConfig.successGlow,
