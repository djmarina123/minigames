...
class MinesweeperFloatingLabel extends PositionComponent {
  MinesweeperFloatingLabel({
...
class MinesweeperCellBurst extends PositionComponent {
  MinesweeperCellBurst({
    required super.position,
    this.color = MinesweeperConfig.successGlow,
  }) : super(size: Vector2.all(8), anchor: Anchor.center);

  final Color color;

  static const _duration = 0.28;
  double _age = 0;
